var student = { name: , height: , ID: , favColor: };

// let name = prompt("What is your name?");
// let height = prompt("How tall are you?");
// let ID = prompt("What is your ID number?");
// let favColor = prompt("What is youre favourite color?");
...
const gradeCalculator = function (gradeObj) {
    const length = Object.keys(gradeObj).length;
    let total = 0;
    for (const key in gradeObj) {
      total = total + gradeObj[key];
    }
    return total / length;
  };
  ...
  let Rose = new Student('Rose Aponte', 09876, 12, 30.2);
  console.log(Rose);
